        ...
        >
          ...
          <h6 className={classes.cardCategoryWhite}>
            ...
            {date.times.length > 2 ? (
              ...
              date.times.map((time, i) => <span key={i}>{moment(time).calendar()}</span>)
            )}
          </h6>
            ...
            {date.attending
              ...
              .map((usr, i) => {
                let chat = currentUser
                  ...
                  : false
                let liked = currentUser ? currentUser.liked.find(x => x.id === usr.id) : false
                return (
                  <div
                    key={usr.id}
                  ...
                  >
                    ...
                    >
                      {liked && <Favorite className={classes.userFavorite} />}{' '}
                      <p style={{ margin: 0 }} className={classes.title}>
                        {usr.firstName} <span style={{ padding: '0 3px' }}>&#8226;</span>{' '}
                      </p>
                      <p style={{ margin: '0 0 0 2px' }} className={classes.title}>
                        {getAge(usr.dob)}
                      </p>
