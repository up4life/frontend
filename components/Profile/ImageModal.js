      ...
      <GridContainer>
        ...
        <GridItem sm={6} md={4} lg={4} style={{ paddingBottom: '15px' }}>
          <div
            className={classes.profileImgLg}
            style={{
              backgroundImage: `url(${userImgs[1] ? userImgs[1].img_url : profileStandIn})`
            }}
          >
            {userImgs[1] ? (
              <Fragment>
        ...
        <GridItem sm={6} md={4} lg={4} style={{ paddingBottom: '15px' }}>
          <div
            ...
            style={{
              marginBottom: '10px',
              backgroundImage: `url(${userImgs[2] ? userImgs[2].img_url : profileStandIn})`
            }}
          >
            {userImgs[2] ? (
              <Fragment>
                <Button
                  className="view-all"
                  color="rose"
                  onClick={() => setDefaultImg({ variables: { id: userImgs[2].id } })}
                >
                  Make Default
                </Button>
                <IconButton
                  onClick={() => deleteImage({ variables: { id: userImgs[2].id } })}
                  className="delete-img"
                >
                  <Delete />
                </IconButton>
        ...
        <GridItem sm={6} md={4} lg={4} style={{ paddingTop: '15px' }}>
          <div
            className={classes.profileImgLg}
            style={{
              backgroundImage: `url(${userImgs[3] ? userImgs[3].img_url : profileStandIn})`
            }}
          >
            {userImgs[3] ? (
              <Fragment>
                <Button
                  className="view-all"
                  onClick={() => setDefaultImg({ variables: { id: userImgs[3].id } })}
                >
                  Make Default
                </Button>
                <IconButton
                  onClick={() => deleteImage({ variables: { id: userImgs[3].id } })}
                  className="delete-img"
                >
                  <Delete />
                </IconButton>
        ...
        <GridItem sm={6} md={4} lg={4} style={{ paddingTop: '15px' }}>
          <div
            className={classes.profileImgLg}
            style={{
              backgroundImage: `url(${userImgs[4] ? userImgs[4].img_url : profileStandIn})`
            }}
          >
            {userImgs[4] ? (
              <Fragment>
                <Button
                  className="view-all"
                  onClick={() => setDefaultImg({ variables: { id: userImgs[4].id } })}
                >
                  Make Default
                </Button>
                <IconButton
                  onClick={() => deleteImage({ variables: { id: userImgs[4].id } })}
                  className="delete-img"
                >
                  <Delete />
                </IconButton>
        ...
        <GridItem sm={6} md={4} lg={4} style={{ paddingTop: '15px' }}>
          <div
            ...
            style={{
              // position: 'relative',
              backgroundImage: `url(${userImgs[5] ? userImgs[5].img_url : profileStandIn})`
            }}
          >
            {userImgs[5] ? (
              <Fragment>
                <Button
                  className="view-all"
                  color="rose"
                  onClick={() => setDefaultImg({ variables: { id: userImgs[5].id } })}
                >
                  Make Default
                </Button>
                <IconButton
                  onClick={() => deleteImage({ variables: { id: userImgs[5].id } })}
                  className="delete-img"
                >
                  <Delete />
                </IconButton>
