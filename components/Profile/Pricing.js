      ...
      <GridContainer>
        <GridItem md={4} sm={4}>
          ...
          >
            <CardBody pricing>
              {' '}
              <h6 className={`${classes.cardCategory} ${classes.marginBottom20}`}>Basic</h6>{' '}
              <div className={classes.icon}>
                <Done className={currentSubs === 'FREE' ? classes.iconWhite : classes.iconRose} />
              </div>
              <h3
                className={`${
                  currentSubs !== 'FREE' ? classes.cardTitle : classes.cardTitleWhite
                } ${classes.marginTop30}`}
              >
                FREE
              </h3>
              <ul style={{ marginBottom: '36px' }}>
                ...
                <li>
                  <span style={{ textDecoration: 'line-through' }}>See who likes you </span>
                  <Close
                    style={{
                      fontSize: '16px',
                      marginBottom: '5px',
                ...
                <li>
                  <span style={{ textDecoration: 'line-through' }}>View read receipts</span>
                  <Close
                    style={{
                      fontSize: '16px',
                      marginBottom: '5px',
        ...
        <GridItem sm={4} md={4}>
          ...
          >
            <CardBody pricing plain={currentSubs !== 'MONTHLY'}>
              <h6 className={`${classes.cardCategoryWhite} ${classes.marginBottom20}`}>
                Month to Month
              </h6>
              <div className={classes.icon}>
                <DoneAll
                  className={currentSubs !== 'MONTHLY' ? classes.iconRose : classes.iconWhite}
                />
              </div>
        ...
        <GridItem sm={4} md={4} lg={4}>
          ...
          >
            <CardBody pricing plain={currentSubs !== 'YEARLY'}>
              <h6 className={`${classes.cardCategoryWhite} ${classes.marginBottom20}`}>Yearly</h6>
              <div className={classes.icon}>
                <DoneOutline
                  className={currentSubs !== 'YEARLY' ? classes.iconRose : classes.iconWhite}
                />
              </div>
              <h3 className={`${classes.cardTitleWhite} ${classes.marginTop30}`}>
