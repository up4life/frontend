...
const Terms = ({ setTermsShowing }) => {
  return (
    <div style={{ padding: '15px' }}>
      ...
      <a href="https://app.termly.io/document/privacy-policy/f9dba20d-bd81-4346-a79e-9efe9d04e937">
        <p>Privacy Policy</p>
      </a>
      <p>
        These terms and conditions outline the rules and regulations for the use of Up4's Website.
      </p>{' '}
      <p>
        By accessing this website we assume you accept these terms and conditions in full. Do not
        continue to use Up4's website if you do not accept all of the terms and conditions stated on
        this page.
      </p>
      <p>
        ...
        accordance with and subject to, prevailing law of . Any use of the above terminology or
        other words in the singular, plural, capitalisation and/or he/she or they, are taken as
        interchangeable and therefore as referring to same.
      </p>
      <h2>Cookies</h2>
      <p>
        We employ the use of cookies. By using Up4's website you consent to the use of cookies in
        accordance with Up4’s privacy policy.
      </p>
      <p>
      ...
      <h2>License</h2>
      <p>
        Unless otherwise stated, Up4 and/or it’s licensors own the intellectual property rights for
        all material on Up4. All intellectual property rights are reserved. You may view and/or
        print pages from http://www.up4.life for your own personal use subject to restrictions set
        in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ol>
        <li>Republish material from http://www.up4.life</li>
        <li>Sell, rent or sub-license material from http://www.up4.life</li>
        <li>Reproduce, duplicate or copy material from http://www.up4.life</li>
      </ol>
      <p>Redistribute content from Up4 (unless content is specifically made for redistribution).</p>
      <h2>User Comments</h2>
      <ol>
        <li>This Agreement shall begin on the date hereof.</li>
        <li>
          Certain parts of this website offer the opportunity for users to post and exchange
          opinions, information, material and data ('Comments') in areas of the website. Up4 does
          not screen, edit, publish or review Comments prior to their appearance on the website and
          Comments do not reflect the views or opinions ofUp4, its agents or affiliates. Comments
          reflect the view and opinion of the person who posts such view or opinion. To the extent
          permitted by applicable laws Up4shall not be responsible or liable for the Comments or for
          any loss cost, liability, damages or expenses caused and or suffered as a result of any
          use of and/or posting of and/or appearance of the Comments on this website.
        </li>
        <li>
          Up4reserves the right to monitor all Comments and to remove any Comments which it
        ...
        <li>
          ...
          <ol>
            ...
            <li>
              The Comments do not infringe any intellectual property right, including without
              limitation copyright, patent or trademark, or other proprietary right of any third
              party;
            </li>
            <li>
              The Comments do not contain any defamatory, libelous, offensive, indecent or otherwise
              unlawful material or material which is an invasion of privacy
            </li>
            <li>
        ...
        <li>
          You hereby grant to <strong>Up4</strong> a non-exclusive royalty-free license to use,
      ...
      <p>
        ...
        with the hyperlink outweighs the absence of Up4; and (d) where the link is in the context of
        general resource information or is otherwise consistent with editorial content in a
      ...
      <p>
        ...
        to our website, you must notify us by sending an e-mail to{' '}
        <a href="mailto:us@cooltable.io" title="send an email to us@cooltable.io">
          us@cooltable.io
        </a>
      ...
      <p>
        No use of Up4’s logo or other artwork will be allowed for linking absent a trademark license
        agreement.
      </p>
      <h2>Iframes</h2>
      <p>
      ...
      <p>
        ...
        <a href="https://termsandconditionstemplate.com">termsandconditionstemplate.com</a>{' '}
